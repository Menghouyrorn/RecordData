            ...
            <div class="right">
                ...
                <%
                    ...
                    if(get==null){
                        ...
                        out.print("<form action='./todolistadmin.jsp' method='post'>");
...
//                    out.print(date);
                    if(description==null && date==null){
                        ...
                        String query="INSERT INTO `todolist`(`description`, `date`,`by`,`status`) VALUES (?,?,'username','enable')";
                ...
                <div class="table_detail">
                    ...
                    if(search==null){
                        int id=0;
                                int iddatabase;
                                String descriptions="",dates="",by="";
                            try{
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/record","root","");
                                String query="SELECT * FROM `todolist` where `status`='enable' ORDER BY `id` DESC LIMIT 12";
                                PreparedStatement pst=con.prepareStatement(query);
                        ...
                        try{
                            int id=0;
                                int iddatabase;
                                String descriptions="",dates="",bys="";
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/record","root","");
                                String query="SELECT * FROM `todolist` where `status`='enable' AND (`description` LIKE '%"+search+"%' OR `date` LIKE '%"+search+"%') ORDER BY `id` DESC LIMIT 12";
                                PreparedStatement pst=con.prepareStatement(query);
                                ResultSet rs=pst.executeQuery();
                                while(rs.next()){
                                id++;
...
//                                int iddata;
                                ...
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/record","root","");
                                String query="SELECT * FROM `todolist` WHERE `id`='"+ids+"'";
                                PreparedStatement pst=con.prepareStatement(query);
                                ResultSet rs=pst.executeQuery();
                                while(rs.next()){
                            ...
                            if(idd==null){
                                ...
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/record","root","");
                                String query="UPDATE `todolist` SET `status`='disable' WHERE `id`='"+idd+"'";
                                PreparedStatement pst=con.prepareStatement(query);
...
//                                    out.print(ids);
                                ...
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/record","root","");
                                String query="UPDATE `todolist` SET `description`='"+descriptionu+"',`date`='"+dateu+"' WHERE `id`='"+idu+"'";
                                PreparedStatement pst=con.prepareStatement(query);
                                int rs=pst.executeUpdate();
                                if(rs==1){
